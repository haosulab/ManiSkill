...
class XArm6Robotiq140(BaseAgent):
    ...
    def _after_loading_articulation(self):
        right_inner_finger_joint = self.robot.active_joints_map["right_inner_finger_joint"]
        right_inner_knuckle_joint = self.robot.active_joints_map["right_inner_knuckle_joint"]
        ...
        left_inner_finger_joint = self.robot.active_joints_map["left_inner_finger_joint"]
        left_inner_knuckle_joint = self.robot.active_joints_map["left_inner_knuckle_joint"]
        ...
        left_drive = self.scene.create_drive(
            left_inner_knuckle, sapien.Pose(p_f_left), left_inner_finger, sapien.Pose(p_p_left)
        )
...
class XArm6RobotiqWristCamera(XArm6Robotiq140):
