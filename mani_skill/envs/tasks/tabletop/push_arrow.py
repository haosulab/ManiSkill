    ...
    **Success Conditions:**
    ...
    def _load_scene(self, options: dict):
        ...
        def create_arrow(name="arrow", target=False, base_color=TARGET_RED):
            ...
            # )
            if not target:
                builder.add_visual_from_file("mani_skill/assets/push_arrow/arrow.glb")
                builder.add_multiple_convex_collisions_from_file("mani_skill/assets/push_arrow/arrow.glb", decomposition="coacd")
    ...
    def compute_dense_reward(self, obs: Any, action: Array, info: Dict):
        ...
        rot_rew = (arrow_z_eulers - self.goal_z_rot).cos()
