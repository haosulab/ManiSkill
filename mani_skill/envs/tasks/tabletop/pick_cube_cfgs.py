...
PICK_CUBE_CONFIGS = {
    ...
    "so100": {
        ...
        "cube_spawn_center": (-0.48, 0),
        "max_goal_height": 0.15,
        "sensor_cam_eye_pos": [-0.27, 0, 0.4],
        "sensor_cam_target_pos": [-0.58, 0, -0.25],
        # "human_cam_eye_pos": [-0.27, 0, 0.4],
        # "human_cam_target_pos": [-0.58, 0, -0.25],
        "human_cam_eye_pos": [-0.1, 0.3, 0.4],
        "human_cam_target_pos": [-0.48, 0.0, 0.1],
    },
}
