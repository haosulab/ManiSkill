...
for env_id in PlaceCube-v1 # PickCube-v1 PushCube-v1 StackCube-v1 PegInsertionSide-v1 PlugCharger-v1
do
    python -m mani_skill.examples.motionplanning.xarm6.run --env-id $env_id \
      --traj-name="trajectory" --only-count-success --save-video -n 1 --vis \
