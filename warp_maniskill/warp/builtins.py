...
add_builtin("isnan", input_types={"x": float}, value_type=bool, doc="Check isnan", group="Scalar Math")
...
add_builtin("svd3", input_types={"A": mat33}, value_type=[mat33, vec3, mat33], group="Vector Math",
    doc="""Compute the SVD of a 3x3 matrix, returning (U, sigma, V). The singular values are returned in sigma,
...
add_builtin("dense_volume_sample_f", input_types={"id": uint64, "xyz": vec3}, value_type=float, group="Volumes",
    doc="""Sample the dense volume given by ``id`` at the local-space point ``xyz``.""")
add_builtin("dense_volume_sample_vec4", input_types={"id": uint64, "xyz": vec3}, value_type=vec4, group="Volumes",
    doc="""Sample the dense volume given by ``id`` at the local-space point ``xyz``.""")
...
add_builtin("atomic_min", input_types={"a": array(dtype=Any), "i": int, "value": Any}, value_func=atomic_op_value_type, doc="Atomically take min between ``value`` and element of array at location given by index.", group="Utility", skip_replay=True)
add_builtin("atomic_min", input_types={"a": array(dtype=Any), "i": int, "j": int, "value": Any}, value_func=atomic_op_value_type, doc="Atomically take min between ``value`` and element of array at location given by indices.", group="Utility", skip_replay=True)
add_builtin("atomic_min", input_types={"a": array(dtype=Any), "i": int, "j": int, "k": int, "value": Any}, value_func=atomic_op_value_type, doc="Atomically take min between ``value`` and element of array at location given by indices.", group="Utility", skip_replay=True)
add_builtin("atomic_min", input_types={"a": array(dtype=Any), "i": int, "j": int, "k": int, "l": int, "value": Any}, value_func=atomic_op_value_type, doc="Atomically take min between ``value`` and element of array at location given by indices.", group="Utility", skip_replay=True)

add_builtin("atomic_max", input_types={"a": array(dtype=Any), "i": int, "value": Any}, value_func=atomic_op_value_type, doc="Atomically take max between ``value`` and element of array at location given by index.", group="Utility", skip_replay=True)
add_builtin("atomic_max", input_types={"a": array(dtype=Any), "i": int, "j": int, "value": Any}, value_func=atomic_op_value_type, doc="Atomically take max between ``value`` and element of array at location given by indices.", group="Utility", skip_replay=True)
add_builtin("atomic_max", input_types={"a": array(dtype=Any), "i": int, "j": int, "k": int, "value": Any}, value_func=atomic_op_value_type, doc="Atomically take max between ``value`` and element of array at location given by indices.", group="Utility", skip_replay=True)
add_builtin("atomic_max", input_types={"a": array(dtype=Any), "i": int, "j": int, "k": int, "l": int, "value": Any}, value_func=atomic_op_value_type, doc="Atomically take max between ``value`` and element of array at location given by indices.", group="Utility", skip_replay=True)
