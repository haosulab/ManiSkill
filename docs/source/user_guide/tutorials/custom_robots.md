...
To get started, you first need to get a valid URDF file like this one for the Panda robot: https://github.com/haosulab/ManiSkill/blob/dev/mani_skill/assets/robots/panda/panda_v2.urdf
...
<!-- For a starting template check out https://github.com/haosulab/ManiSkill/blob/dev/mani_skill/agents/robots/_template/template_robot.py -->
...
For example code that loads the robot and the scene see https://github.com/haosulab/ManiSkill/blob/dev/mani_skill/envs/tasks/control/cartpole.py
...
For now see the implementation of [Allegro hand with touch sensors](https://github.com/haosulab/ManiSkill/blob/dev/mani_skill/agents/robots/allegro_hand/allegro_touch.py)
