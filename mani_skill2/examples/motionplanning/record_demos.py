...
Run python mani_skill2/examples/motionplanning/record_demos.py to test it out, which will generate one successful video per task with a MP solution

Run python mani_skill2/examples/motionplanning/record_demos.py --no-video -n 1000 to mass generate a demo dataset
