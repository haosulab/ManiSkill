...
def main():
    ...
    for env_name, env_path in env_paths.items():
        ...
        out_trajectory_path = os.path.join(args.out_dir, f"{env_id}/rl/trajectory.h5")
        ...
        with open(os.path.join(args.out_dir, f"{env_id}/rl/trajectory.json"), "w") as f:
            json.dump(new_metadata, f, indent=2)
        print(f"Saved to {os.path.join(args.out_dir, f'{env_id}/rl/trajectory.json')}")
        out_file.close()
