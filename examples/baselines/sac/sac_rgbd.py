...
class ReplayBuffer:
    def __init__(self, env, num_envs: int, buffer_size: int, storage_device: torch.device, sample_device: torch.device):
        ...
        self.obs = DictArray((args.num_steps, args.num_envs), envs.single_observation_space, device=device)
...
if __name__ == "__main__":
    ...
    # env setup
    env_kwargs = dict(obs_mode=args.obs_mode, control_mode="pd_joint_delta_pos", render_mode="rgb_array", sim_backend="gpu")
