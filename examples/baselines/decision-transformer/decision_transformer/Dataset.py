...
def load_batch(dataset:ManiSkill2Dataset,batch_size=16, max_len=20, num_trajectories=100, state_dim=42, act_dim = 7, max_ep_len=90, scale = 50):
    ...
    for i in range(batch_size):
        ...
        rtg.append(discount_cumsum(rew[si:], gamma=1.)[:s[-1].shape[1] + 1].reshape(1, -1, 1))
        tlen = s[-1].shape[1]
