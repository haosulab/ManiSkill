...
parser.add_argument("--env", type=str, help="Specifies the env to run the training: PickCube-v0, LiftCube-v0, StackCube-v0")
...
dataset = ManiSkill2Dataset(parser.dataset)
state_mean, state_std = dataset.get_state_stats()

variant = {
    "embed_dim": parser.embed_dim,
    "n_layer": parser.n_layer,
    "n_head": parser.n_head,
    "dropout": 0.1,
