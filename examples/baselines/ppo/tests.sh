...
do
    ...
    python ppo_leanrl.py --env_id="PickCube-v1" --seed=${seed} \
        --num_envs=1024 --update_epochs=12 --num_minibatches=32 \
        --total_timesteps=10_000_000 \
        --num_eval_envs=16 \
        --num-steps=10 --eval-freq=10 \
        --exp-name="ppo-leanrl-cudagraphs-PickCube-v1-state-${seed}-no-finite-horizon-gae-1024envs-10steps-walltime_efficient" \
...
do
    ...
    python ppo_leanrl.py --env_id="PushT-v1" --seed=${seed} \
        --num_envs=4096 --update_epochs=16 --num_minibatches=32 --gamma=0.99 \
        --total_timesteps=50_000_000 --num-steps=10 --num_eval_steps=100 \
        --num_eval_envs=16 \
        --exp-name="ppo-leanrl-cudagraphs-PushT-v1-state-${seed}-no-finite-horizon-gae-4096envs-10steps-walltime_efficient" \
        --wandb_entity="stonet2000" --wandb_project_name="PPO-ManiSkill-GPU-SpeedRun" --cudagraphs
    
    python ppo_leanrl.py --env_id="PushT-v1" --seed=${seed} \
        --num_envs=4096 --update_epochs=16 --num_minibatches=32 --gamma=0.99 \
        --total_timesteps=50_000_000 --num-steps=5 --num_eval_steps=100 \
        --num_eval_envs=16 \
        --exp-name="ppo-leanrl-cudagraphs-PushT-v1-state-${seed}-no-finite-horizon-gae-4096envs-5steps-walltime_efficient" \
        --wandb_entity="stonet2000" --wandb_project_name="PPO-ManiSkill-GPU-SpeedRun" --cudagraphs
done
