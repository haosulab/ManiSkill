...
if __name__ == "__main__":
    ...
    eval_envs = gym.make(args.env_id, num_envs=args.num_eval_envs, reconfigure_freq=args.eval_reconfiguration_freq, **env_kwargs)
    envs = gym.make(args.env_id, num_envs=args.num_envs if not args.evaluate else 1, reconfigure_freq=args.reconfiguration_freq, **env_kwargs)
