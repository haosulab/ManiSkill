...
if __name__ == "__main__":
    ...
    if args.capture_video or args.save_trajectory:
        ...
        eval_envs = RecordEpisode(eval_envs, output_dir=eval_output_dir, save_trajectory=args.save_trajectory, save_video=args.capture_video, trajectory_name="trajectory", max_steps_per_video=args.num_eval_steps, video_fps=20, render_substeps=False, info_on_video=True)
